    ...
    <div class="main-bg">
      <div class="main-inside">
        <div class="assets-common-container">
          <el-container>
            <h3 style="font-size:24px;">资产领用流程</h3>
...
export default {
  ...
  methods: {
    postSave(data) {
      this.$http.post("assetUse/save", data).then(res => {
        this.$notify({
          title: "成功",
    ...
    assetUserAdd(val) {
      ...
      if (this.tableData.length > 0) {
        ...
        if (!this.state) {
            ...
            .then(
              res => {
                ...
                if (val == 2) {
                  this.$notify({
                    title: "成功",
                    message: "资产领用信息提交成功，请等待管理员审核",
                    type: "success"
                  });
                } else if (val == 1) {
                  this.$notify({
                    title: "成功",
                    message: "资产领用信息成功保存至草稿箱",
                    type: "success"
                  });
                }
              },
          ...
          //console.log(data)
          this.$http
            .post("/assetUse/reject/submit", data)
            .then(
              res => {
                this.tableData = [];
                this.selectList = [];
    ...
    searchAssets() {
      ...
      console.log(this.assetPagerData);
